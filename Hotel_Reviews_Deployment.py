...
svm_deploy=load(open('D:\Project\PROJECT HOTEL REVIEWS\svm.pkl','rb'))
cv_deploy=load(open(r'D:\Project\PROJECT HOTEL REVIEWS\tf_vector.pkl','rb'))
...
z=cv_deploy.transform([lemmatize(cleaned_text)])
...
if st.button("Emotion"):
    ...
    svm_deploy = open('D:\Project\PROJECT HOTEL REVIEWS\svm.pkl', 'rb')
    model = pickle.load(svm_deploy)
    cv_deploy = open(r'D:\Project\PROJECT HOTEL REVIEWS\tf_vector.pkl', 'rb')
